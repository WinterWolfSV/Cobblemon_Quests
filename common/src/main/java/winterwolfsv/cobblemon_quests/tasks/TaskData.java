...
public class TaskData {
    ...
    public static final List<String> actionList = Arrays.asList("catch", "defeat", "defeat-player", "defeat-npc", "evolve", "kill", "level_up", "level_up_to", "release", "trade_away", "trade_for", "obtain", "select_starter", "revive_fossil");
